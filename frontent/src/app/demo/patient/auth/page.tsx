      ...
      <PageContainer maxWidth="sm">
        <Card padding="lg" className="mt-8 animate-fadeUp">
          ...
          <div className="bg-bgLight rounded-xl p-1 flex mt-6">
            <button
              className={`flex-1 py-2 rounded-lg text-sm transition-all duration-200 ${activeTab === "login"
            ...
            <button
              className={`flex-1 py-2 rounded-lg text-sm transition-all duration-200 ${activeTab === "signup"
                  ? "bg-white shadow-sm text-primary font-semibold"
                  : "text-primary/50 hover:text-primary"
                }`}
